---
title: "Caddy as a Reverse Proxy: From 3 Lines to a Real Setup"
description: "Caddy is probably the easiest reverse proxy I have used so far. A tutorial from zero to a production-ready Caddyfile."
pubDate: 2026-06-13
author: "Timo"
tags: ["caddy", "tutorial", "reverse-proxy", "docker", "self-hosting"]
---
