---
title: "I added a local audio compressor to my browser extension"
description: "How I built a local Web Audio API compressor directly into KoalaSync to normalize loud explosions and quiet dialogue."
pubDate: 2026-06-10
author: "Timo"
canonicalUrl: "https://dev.to/shik3i/i-added-a-local-audio-compressor-to-my-browser-extension-2a1o"
tags: ["koalasync", "web-audio-api", "browser-extension"]
---
