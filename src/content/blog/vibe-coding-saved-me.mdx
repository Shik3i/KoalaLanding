...
Not because AI magically solves everything. It really does not.

But because it moved me into a different role.
...
I am not forced to push code I already know will become technical debt.

Instead, I get to make the decisions.
...
The AI can suggest things, but it does not get the final word.
...
I did not manually write a single line of KoalaSync code myself.

Not even the tiny fixes.
...
But I did not hand-type the implementation.

That is a weird sentence to write as a developer.

But it is also honestly the thing that made the project possible for me.
...
So I looked into Wails.

I had never worked with Wails before.
...
That is another part people sometimes miss.

AI-assisted coding does not have to mean you learn nothing.
...
It changed which part of development I spend my free time on.

I no longer want to manually code side projects after work.
...
Not the corporate ticket grind.

Not the late-night emergency fixes.

Not the “ship it now, fix it forever” cycle.
